...
public class StudentsView extends javax.swing.JFrame {
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel2Layout.createSequentialGroup()
                                .addGap(49, 49, 49)
                                .addComponent(lblMsg, javax.swing.GroupLayout.PREFERRED_SIZE, 264, javax.swing.GroupLayout.PREFERRED_SIZE))
                            .addGroup(jPanel2Layout.createSequentialGroup()
                                .addContainerGap()
    ...
    private void btnWriteToFileActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnWriteToFileActionPerformed
        ...
        if (txtId.getText().length() < 3) {
            ...
            for (int i = 0; i < students.size(); i++) {
                ...
                try {
                    StudentsUtil.writeToFile("Habib", students); 
                } catch (Exception e) {
                    Logger.getLogger(StudentsView.class.getName()).log(Level.SEVERE, null,e);
                }
            }
            lblMsg.setText("Successfully Added To File And Table"); 
        }
    ...
    private void btnDisplayFromFileActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDisplayFromFileActionPerformed
        ...
        StudentsUtil.displayFromFile("Habib", tableModel); 
    ...
    private void btnClearActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnClearActionPerformed
        ...
        cmbRound.getItemAt(cmbRound.getSelectedIndex());
        txtMsg.setText(""); 
